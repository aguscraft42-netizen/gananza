...
export default async function AdminPage() {
  const [context, metrics, queue, flags] = await Promise.all([getAppContext(), getAdminMetrics(), getAdminQueue(), getFraudFlags()]);
  ...
  return (
    <AppShell active="/admin">
      <section className="page-content">
        ...
        <div className="admin-notice"><span>!</span><p><strong>{context.configured ? "Auditoría activa." : "Entorno de demostración."}</strong> Las transiciones financieras se ejecutan mediante funciones SQL y quedan registradas.</p></div>
