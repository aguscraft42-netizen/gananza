...
export default async function TasksPage() {
  ...
  return <AppShell active="/tareas"><section className="page-content">
    <div className="v3-page-heading">
      <div><span className="eyebrow">OPORTUNIDADES</span><h1>Elegí tu próxima tarea.</h1><p>Compará objetivo, duración, validación y recompensa antes de empezar.</p></div>
      <div className="heading-trust"><span><Icon name="shield" size={19}/></span><div><strong>{context.configured ? "Seguimiento protegido" : "Vista de demostración"}</strong><small>{context.configured ? "Cada avance queda asociado a tu cuenta." : "Los cambios viven sólo en esta sesión."}</small></div></div>
    </div>
    ...
    <TaskExplorer initialTasks={tasks} realMode={context.configured}/>
  </section></AppShell>;
}
